        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex flex-col items-center justify-center p-6 space-y-4">
            <div className="bg-white p-4 rounded-xl shadow-sm border">
              <QRCode
                value="https://github.com/kibrit74/videokoleks/releases/latest/download/app-debug.zip"
                size={200}
            ...
            <p className="text-sm text-muted-foreground text-center">
              Veya <a href="https://github.com/kibrit74/videokoleks/releases/latest/download/app-debug.zip" className="text-primary hover:underline font-medium">buraya tıklayarak</a> indirebilirsiniz.
            </p>
          </div>
        </DialogContent>
      </Dialog>
