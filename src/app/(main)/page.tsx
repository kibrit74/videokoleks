      ...
      <Dialog open={isMobileAppOpen} onOpenChange={setMobileAppOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Android uygulamasını indirmek için aşağıdaki QR kodu telefonunuzun kamerasıyla okutun. (Sürüm: v1.0.22)
            </DialogDescription>
          </DialogHeader>
          <div className="flex flex-col items-center justify-center p-6 space-y-4">
            <div className="bg-white p-4 rounded-xl shadow-sm border">
              <QRCode
                value="https://github.com/kibrit74/videokoleks/releases/tag/v1.0.22"
                size={200}
            ...
            <p className="text-sm text-muted-foreground text-center">
              Veya <a href="https://github.com/kibrit74/videokoleks/releases/tag/v1.0.22" className="text-primary hover:underline font-medium">buraya tıklayarak</a> indirebilirsiniz.
            </p>
          </div>
        </DialogContent>
      </Dialog>
