...
export default function RegisterPage() {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            toast({ title: 'Başarıyla kayıt oldunuz ve giriş yaptınız.' });
            router.push('/');
        } catch (error) {
            toast({ variant: "destructive", title: 'Kayıt olunamadı.', description: 'Google ile kayıt olurken bir hata oluştu.' });
        }
    }
        ...
        <div className="flex items-center justify-center min-h-screen bg-background">
            <Card className="w-full max-w-sm">
                <CardHeader className="text-center">
                    ...
                    <CardDescription>Koleksiyonunuzu kaydetmek için şimdi katılın.</CardDescription>
                </CardHeader>
